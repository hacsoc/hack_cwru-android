...
public class FirstTimeActivity extends AppCompatActivity {
    ...
    public void onHackerClick(View view) {
        Intent intent = new Intent(this, RegisterHackerActivity.class);
        startActivity(intent);
    }

    public void onMentorClick(View view) {
        Intent intent = new Intent(this, RegisterMentorActivity.class);
        startActivity(intent);
    }
